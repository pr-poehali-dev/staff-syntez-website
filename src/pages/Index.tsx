...
const services = [
  {
    ...
    details: ["Оформление в штат нашей компании", "Любые категории специалистов", "Гибкие условия сотрудничества"],
  },
  {
    icon: "Briefcase",
      ...
      <section id="home" className="relative min-h-screen flex items-center overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-6 pt-32 pb-24 w-full">
          <div className="max-w-3xl">
            ...
            >
              ГК СТАФФСИНТЕЗ — комплексный провайдер аутсорсинговых и аутстаффинговых услуг. Берём на себя всё: подбор, оформление, управление персоналом.
            </p>
